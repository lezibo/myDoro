...
pub const DEFAULT_TIME_IMAGE_INTERVAL_SECS: u16 = 60;
...
fn default_time_image_interval_secs() -> u16 {
    DEFAULT_TIME_IMAGE_INTERVAL_SECS
}
...
pub fn normalize_time_image_interval_secs(secs: u16) -> u16 {
    match secs {
        0 | 60 | 120 | 180 | 300 => secs,
        _ => DEFAULT_TIME_IMAGE_INTERVAL_SECS,
    }
}
...
pub fn load(app: &AppHandle) -> Prefs {
    ...
    prefs.time_image_interval_secs =
        normalize_time_image_interval_secs(prefs.time_image_interval_secs);
    prefs
}
...
mod tests {
    ...
    #[test]
    fn test_time_image_interval_normalization() {
        assert_eq!(normalize_time_image_interval_secs(0), 0);
        assert_eq!(normalize_time_image_interval_secs(60), 60);
        assert_eq!(normalize_time_image_interval_secs(120), 120);
        assert_eq!(
            normalize_time_image_interval_secs(42),
            DEFAULT_TIME_IMAGE_INTERVAL_SECS
        );
    }
