...
pub fn bubble_drag_finished(
    ...
    .unwrap_or_else(|| {
        ...
        (
            ...
            first_bubble_y(&anchor, &monitor, stack_above, first_height, gap, margin, 0),
        )
    });
...
#[tauri::command]
pub fn dismiss_bubble(app: AppHandle, bubbles: tauri::State<BubbleMap>, id: String) {
    prepare_close_bubble(&app, &bubbles, &id);
}
...
mod tests {
    ...
    fn test_first_bubble_y_applies_vertical_offset_once() {
        ...
        let above_base =
            first_bubble_y(&anchor_above, &monitor, true, first_height, gap, margin, 0);
        ...
        let below_base =
            first_bubble_y(&anchor_below, &monitor, false, first_height, gap, margin, 0);
    ...
    fn test_bubble_origin_for_id_uses_non_first_stack_basis_above() {
        ...
        let (offset_x, offset_y) = relative_bubble_offset(
            second_origin.0,
            second_origin.1,
            dragged_pos.0,
            dragged_pos.1,
